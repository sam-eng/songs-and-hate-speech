...
trump_lyrics = [line.rstrip('\n') for line in open("../data/trump_tweets_lyrics.txt")]
...
def get_tweets_predictions(tweets, perform_prints=True):
    ...
    #model = pickle.load('final_model.pkl', encoding='latin1')

    print ("Loading other information...")
    with open('final_tfidf.pkl', "rb") as f1:
        tf_vectorizer = pickle.load(f1,encoding='bytes')
    with open('final_idf.pkl', "rb") as f2:
        idf_vector = pickle.load(f2,encoding='bytes')
    with open('final_pos.pkl', "rb") as f3:
        pos_vectorizer = pickle.load(f3,encoding='bytes')
    #tf_vectorizer = pickle.load('final_tfidf.pkl',encoding='latin1')
    #idf_vector = pickle.load('final_idf.pkl',encoding='latin1')
    #pos_vectorizer = pickle.load('final_pos.pkl',encoding='latin1')
    #Load ngram dict
    #Load pos dictionary
